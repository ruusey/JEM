...
public abstract class APIUtils {
	public static WebApplicationException buildWebApplicationException(
			javax.ws.rs.core.Response.Status httpResponseStatus, APIStatus status, String message,
			String debugMessage) {
		Response response = new Response(status, message, debugMessage);
		return new WebApplicationException(javax.ws.rs.core.Response.status(httpResponseStatus)
	...
	public static String generateJSON(Object classs) {
		...
		try {
			Object jsonObject = objectMapper.readValue(objectMapper.writeValueAsString(classs), Object.class);
